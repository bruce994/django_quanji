...
urlpatterns = [
    ...
    url(r'^app_lession_choices/$', views.app_lession_choices, name='app_lession_choices'),
    ...
    url(r'^lession_list/((?P<id>[0-9]+)/)?(PageNo/(?P<PageNo>[0-9]+)/)?$', views.lession_list, name='lession_list'),
